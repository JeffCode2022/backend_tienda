...
const actualizar_perfil_cliente_guest = async function (req, res) {
    if (req.user) {
        ...
        if (data.password) {
            bcrypt.hash(data.password, null, null, async function (erro, hash) {
                var reg = await Cliente.findByIdAndUpdate({ _id: id }, {
...
const eliminar_direccion_principal_cliente = async function (req, res) {
    if (req.user) {
...
const registro_cliente_guest = async function (req, res) {
    ...
    module.exports = {
        ...
        eliminar_direccion_principal_cliente,
